...
run:
	TEMPLATES_PATH=./examples/templates/ SMTP_URL=smtp://username:password@smtp.mailgun.org SMTP_SENDER=no-reply@novacloud.cz EVENT_TYPE=com.graphql.id.user.invited TO_TEMPLATE="{{.user.email}}" SUBJECT_TEMPLATE="Welcome in CloudEvents world!" PORT=8010 go run *.go
